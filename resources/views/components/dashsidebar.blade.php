{{-- <div class="min-h-screen border-r w-1/5 bg-orange-500 flex flex-col items-start gap-y-2 px-4 py-4">
    <div class="">
        <img class="flex-shrink-0 w-12" src="{{ asset('assets/Logo.png') }}" alt="">
    </div>
    <div class="">
        <ul class="flex flex-col gap-y-1 text-slate-50 tracking-tight leading-relaxed text-lg">
        ...
        <div class="flex flex-col min-w-full px-4">
            ...
            <div class="side-menu">
                <ul class="flex flex-col items-start p-4 pl-2 text-gray-600 font-semibold capitalize">
                    ...
                    <a href="" class="rounded-lg w-full py-2">
                        <li
                            class="flex p-4 rounded-lg {{ Request::is('dashboard/students*') ? 'bg-blue-800 text-white' : '' }} ">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="" class="rounded-lg w-full py-2">
                        <li
                            class="flex p-4 rounded-lg {{ Request::is('dashboard/classes*') ? 'bg-blue-800 text-white' : '' }} ">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="" class="rounded-lg w-full py-2">
                        <li
                            class="flex p-4 rounded-lg {{ Request::is('dashboard/payments*') ? 'bg-blue-800 text-white' : '' }} ">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="" class="rounded-lg w-full py-2">
                        <li
                            class="flex p-4 rounded-lg {{ Request::is('dashboard/users*') ? 'bg-blue-800 text-white' : '' }} ">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button class="rounded-lg w-full py-2">
                            <li
                                class="flex p-4 rounded-lg {{ Request::is('dashboard/users*') ? 'bg-blue-800 text-white' : '' }} ">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
